...
// ===========================================================================
// generateMetadata — gives each card a custom title and description in the
// LinkedIn / X / Slack share preview. The og:image itself is generated by
// the sibling opengraph-image.tsx file.
// ===========================================================================
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${name} — SalesCard Score ${score} (${tier.label})`;
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Verification record — only shown if there's at least one approved verification */}
