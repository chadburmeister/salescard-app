...
export function SalesCardFront({
  ...
  return (
    ...
    >
      ...
      {/* Tier name — forced to fit the 78px-wide panel regardless of how long the label is */}
      ...
      {/* Right gold panel: VERIFIED + grade 10 (autograph label removed) */}
      ...
      {/* (Removed) VER score circle on the upper right — was redundant with the tier panel score */}
